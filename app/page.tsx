...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="top"><div className="hero-copy"><p className="eyebrow light">The Canadian capital-markets job board</p><h1>Find your next seat<br/>on Bay Street.</h1><p>Curated roles, firms and career intelligence for people building careers in Canadian finance.</p></div><div className="hero-stat"><strong>{loading?"—":jobs.length}</strong><span>active opportunities<br/>as of {fmtToday(today)}</span></div><div className="hero-orbit orbit-one"/><div className="hero-orbit orbit-two"/></section>
