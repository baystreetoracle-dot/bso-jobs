...
export default function JobBoard({mode="home",initialCompany=null}:{mode?:"home"|"jobs"|"companies";initialCompany?:string|null}) {
  ...
  const displayedJobs=mode==="home"?jobs.slice(0,6):filtered;
  const displayedCompanies=mode==="home"?companies.slice(0,6):companies;
  ...
  return <main>
    ...
    <footer><Link className="footer-brand" href="/"><img src="/bso-logo.png" alt=""/><span>THE BAY STREET ORACLE</span></Link><div><Link href="/jobs">Jobs</Link><Link href="/companies">Companies</Link><Link href="/#newsletter">Newsletter</Link></div><div><p>Not NYC.<br/>Not trying to be.</p><a href="mailto:info@baystreetoracle.ca">info@baystreetoracle.ca</a></div><small>© 2026 The Bay Street Oracle</small></footer>
