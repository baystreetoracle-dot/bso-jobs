...
type Job = { id:string; externalJobId:string; companyId:string; company:string; title:string; location:string; city:string|null; province:string|null; category:string; seniority:string; storedSeniority:string; program:string; employmentType:string|null; workplaceType:string|null; specialization:string|null; datePosted:string|null; deadline:string|null; url:string; detailPath:string; summary:string; recruitingUpdate:RecruitingUpdate|null };
