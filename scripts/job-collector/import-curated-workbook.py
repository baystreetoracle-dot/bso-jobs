...
ROLES = {
    ...
    13: role("Global Investment Banking, Student Analyst, Winter 2027 Montreal - Bilingual", "2617249", "Montreal, QC", "Student", "Co-op", "Investment Banking", city="Montreal", province="QC", term_start="2027-01-01", term_end="2027-04-30", term_length_months=4, status="closed", quality="Removed from the active BSO job board on 2026-09-19."),
    ...
    15: role("Global Investment Banking Analyst, Winter 2027 (Calgary)", "2618460", "Calgary, AB", "Student", "Co-op", "Investment Banking", city="Calgary", province="AB", term_start="2027-01-01", term_end="2027-04-30", term_length_months=4, status="closed", quality="Removed from the active BSO job board on 2026-09-19."),
